 ...
 public:
  ...
  class Node {
   public:
    ...
    const Point& position() const {
      const Point* vertex = g -> vertices[index()];
      return *vertex;
    }
  ...
  class Edge {
   ...
   private:
     ...
     * @param[in] a Node type
     * @param[in] b Node type
     * @pre @a a and @a b are distinct valid nodes of this graph
     * @post (start == a && end == b) || (start == b && end == a);
     * Complexity: O(1)
     */
    void setVertices(const Node a, const Node b) {
      start = a;
      end = b;
    }
