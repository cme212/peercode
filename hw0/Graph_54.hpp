...
class Graph {
 ...
 public:
  ...
  Node add_node(const Point& position) {
    ...
    internal_node new_internalnode(position, n, last_nid);
  ...
  class Edge {
   ...
   private:
    ...
    Graph* parent;
    const size_type node1_nid;
    const size_type node2_nid;
    const size_type eid;
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    if (has_edge(a,b)) return Edge();// Invalid Edge
    ...
    Edge e(this, a.nid, b.nid, last_eid);
 ...
 private:
  ...
  struct internal_node{
    ...
    internal_node(const Point& point, size_type node_idx, size_type nid) : point(point), 
      node_idx(node_idx), nid(nid) {};
  };
  ...
  //std::map<std::pair<size_type,size_type>, size_type> nodespairs2edges
  //std::map<size_type, std::vector<size_type>*> node2node
