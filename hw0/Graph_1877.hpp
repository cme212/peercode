...
class Graph {
 ...
 public:
  ...
  class Edge {
   ...
   private:
    ...
    Edge(const Graph* g, size_type uid1, size_type uid2){
      graph_=g;
      if (uid1<uid2) {uid1_=uid1; uid2_=uid2;}
      else {uid1_=uid2; uid2_=uid1;} // forces uid1_ < uid2_
    }
  };
  ...
  bool has_edge(const Node& a, const Node& b) const {
    // HW0: YOUR CODE HERE
    size_type less; size_type more;
    if (a.uid_<b.uid_) {less=a.uid_; more=b.uid_;}
    else {less=b.uid_; more=a.uid_;}
    std::vector<size_type> look_less=look_up[less];
    for (size_type i=0; i<look_less.size(); i++){
      if (look_less[i]==more){
        return true;
      }
    }
