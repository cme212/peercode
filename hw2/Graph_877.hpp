...
class Graph {
 ...
 public:
  ...
  /** Predeclaration of generalized Node value type*/
  using node_value_type = V;

  /**Predeclaration of generalized Edge value type*/
  ...
  class Node : private totally_ordered<Node> {
   public:
    ...
    //ex precondition index valid, node exists 
  ...
  class Edge : private totally_ordered<Edge> {
   public:
    ...
    /**
     * @brief Returns value of edge's attribute
     * 
     * Default initializes if no value is provided.
     */
    edge_value_type& value() { 
      return graph_->edges_[idx_].edge_value;
    };
  ...
  node_iterator node_end() const{
    return NodeIterator(this, size_nodes_);
  }
  ...
  class IncidentIterator : private totally_ordered<IncidentIterator>{
   public:
    ...
    Edge operator*() const {
      ...
      if (graph_->edges_[edge_idx].node_a != node_) {
        ...
        graph_->edges_[edge_idx].node_a = node_; 
      }
   ...
   private:
    ...
    IncidentIterator(Graph* graph, Node node, size_type index) : graph_(graph), node_(node), idx_(index) {}
