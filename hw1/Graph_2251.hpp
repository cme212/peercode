  ...
  class Edge : private totally_ordered<Edge> {
   public:
    ...
    bool operator==(const Edge& e) const {
      //HW0: YOUR CODE HERE
      if (graph_ == e.graph_ and *smallNode_ == *e.smallNode_ and *bigNode_ == *e.bigNode_) return true;
      return false;
    }
    ...
    bool operator<(const Edge& e) const {
      //HW0: YOUR CODE HERE
      if (graph_ < e.graph_ or smallNode_ < e.smallNode_ or (smallNode_ == e.smallNode_ and bigNode_ < e.bigNode_)) return true;
      else return false;
    }
   ...
   private:
    ...
    void set_node1_node2(const Node& node1, const Node& node2) {
        node1_ = const_cast<Node*>(&node1);
        node2_ = const_cast<Node*>(&node2);
    }
  };
  ...
  class IncidentIterator : private totally_ordered<IncidentIterator>{
   public:
    ...
    Edge operator*() const {
       ...
       return Edge(graph_, center_ref, node_ref);
    }
    ...
    bool operator==(const IncidentIterator& incident_iter) const {
      ...
      if (graph_ == incident_iter.graph_ and *center_ == *(incident_iter.center_) and incident_itr == incident_iter.incident_itr) {
        return true;
      }
      return false;
    }
